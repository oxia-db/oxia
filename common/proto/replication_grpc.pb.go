...
const (
	...
	OxiaCoordination_FreezeShard_FullMethodName          = "/replication.OxiaCoordination/FreezeShard"
)
...
type OxiaCoordinationClient interface {
	...
	FreezeShard(ctx context.Context, in *FreezeShardRequest, opts ...grpc.CallOption) (*FreezeShardResponse, error)
}
...
func (c *oxiaCoordinationClient) GetInfo(ctx context.Context, in *GetInfoRequest, opts ...grpc.CallOption) (*GetInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, OxiaCoordination_GetInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oxiaCoordinationClient) FreezeShard(ctx context.Context, in *FreezeShardRequest, opts ...grpc.CallOption) (*FreezeShardResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FreezeShardResponse)
	err := c.cc.Invoke(ctx, OxiaCoordination_FreezeShard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OxiaCoordinationServer interface {
	...
	// Used during split cutover to quiesce the parent and let children drain
	// the final tail before the parent is fenced.
	FreezeShard(context.Context, *FreezeShardRequest) (*FreezeShardResponse, error)
...
func (UnimplementedOxiaCoordinationServer) NewTerm(context.Context, *NewTermRequest) (*NewTermResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NewTerm not implemented")
}
func (UnimplementedOxiaCoordinationServer) BecomeLeader(context.Context, *BecomeLeaderRequest) (*BecomeLeaderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BecomeLeader not implemented")
}
func (UnimplementedOxiaCoordinationServer) AddFollower(context.Context, *AddFollowerRequest) (*AddFollowerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddFollower not implemented")
}
...
func (UnimplementedOxiaCoordinationServer) FreezeShard(context.Context, *FreezeShardRequest) (*FreezeShardResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FreezeShard not implemented")
}
...
func RegisterOxiaCoordinationServer(s grpc.ServiceRegistrar, srv OxiaCoordinationServer) {
	// If the following call panics, it indicates UnimplementedOxiaCoordinationServer was
...
func _OxiaCoordination_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(OxiaCoordinationServer).GetInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OxiaCoordination_GetInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OxiaCoordinationServer).GetInfo(ctx, req.(*GetInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OxiaCoordination_FreezeShard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FreezeShardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OxiaCoordinationServer).FreezeShard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OxiaCoordination_FreezeShard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OxiaCoordinationServer).FreezeShard(ctx, req.(*FreezeShardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OxiaCoordination_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FreezeShard",
			Handler:    _OxiaCoordination_FreezeShard_Handler,
		},
	},
...
func RegisterOxiaLogReplicationServer(s grpc.ServiceRegistrar, srv OxiaLogReplicationServer) {
	// If the following call panics, it indicates UnimplementedOxiaLogReplicationServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
