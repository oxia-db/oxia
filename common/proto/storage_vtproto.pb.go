...
func (m *LogEntryValue_ControlRequest) CloneVT() isLogEntryValue_Value {
	if m == nil {
		return (*LogEntryValue_ControlRequest)(nil)
	}
	r := new(LogEntryValue_ControlRequest)
	r.ControlRequest = m.ControlRequest.CloneVT()
	return r
}
...
func (m *ControlRequest) CloneVT() *ControlRequest {
	...
	if m.Value != nil {
		r.Value = m.Value.(interface{ CloneVT() isControlRequest_Value }).CloneVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *ControlRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ControlRequest_FeatureEnable) CloneVT() isControlRequest_Value {
	if m == nil {
		return (*ControlRequest_FeatureEnable)(nil)
	}
	r := new(ControlRequest_FeatureEnable)
	r.FeatureEnable = m.FeatureEnable.CloneVT()
	return r
}
...
func (m *SortedNotificationBatch) CloneVT() *SortedNotificationBatch {
	if m == nil {
		return (*SortedNotificationBatch)(nil)
	}
	r := new(SortedNotificationBatch)
	r.Shard = m.Shard
	r.Offset = m.Offset
	r.Timestamp = m.Timestamp
	if rhs := m.Notifications; rhs != nil {
		tmpContainer := make([]*NotificationBatchEntry, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *SortedNotificationBatch) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *NotificationBatchEntry) CloneVT() *NotificationBatchEntry {
	if m == nil {
		return (*NotificationBatchEntry)(nil)
	}
	r := new(NotificationBatchEntry)
...
func (m *NotificationBatchEntry) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *LogEntryValue_ControlRequest) EqualVT(thatIface isLogEntryValue_Value) bool {
	that, ok := thatIface.(*LogEntryValue_ControlRequest)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.ControlRequest, that.ControlRequest; p != q {
		if p == nil {
			p = &ControlRequest{}
		}
		if q == nil {
...
func (this *ControlRequest) EqualVT(that *ControlRequest) bool {
	...
	if this.Value == nil && that.Value != nil {
		...
		if !this.Value.(interface {
			EqualVT(isControlRequest_Value) bool
		}).EqualVT(that.Value) {
			return false
		}
	}
...
func (this *ControlRequest) EqualMessageVT(thatMsg proto.Message) bool {
...
func (this *ControlRequest_FeatureEnable) EqualVT(thatIface isControlRequest_Value) bool {
	that, ok := thatIface.(*ControlRequest_FeatureEnable)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.FeatureEnable, that.FeatureEnable; p != q {
		if p == nil {
			p = &FeatureEnableRequest{}
		}
		if q == nil {
			q = &FeatureEnableRequest{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *SortedNotificationBatch) EqualVT(that *SortedNotificationBatch) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	for i, vx := range this.Notifications {
		...
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &NotificationBatchEntry{}
			}
			if q == nil {
				q = &NotificationBatchEntry{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *SortedNotificationBatch) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*SortedNotificationBatch)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *NotificationBatchEntry) EqualVT(that *NotificationBatchEntry) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *NotificationBatchEntry) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*NotificationBatchEntry)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *LogEntryValue_ControlRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LogEntryValue_ControlRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ControlRequest != nil {
		size, err := m.ControlRequest.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ControlRequest_FeatureEnable) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ControlRequest_FeatureEnable) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FeatureEnable != nil {
		size, err := m.FeatureEnable.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FeatureEnableRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FeatureEnableRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *SortedNotificationBatch) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *SortedNotificationBatch) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *SortedNotificationBatch) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *NotificationBatchEntry) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *NotificationBatchEntry) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *NotificationBatchEntry) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *LogEntryValue_ControlRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ControlRequest_FeatureEnable) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SortedNotificationBatch) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NotificationBatchEntry) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LogEntryValue) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ControlRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Value.(*LogEntryValue_ControlRequest); ok {
				if err := oneof.ControlRequest.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ControlRequest{}
				...
				m.Value = &LogEntryValue_ControlRequest{ControlRequest: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ControlRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FeatureEnable", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Value.(*ControlRequest_FeatureEnable); ok {
				if err := oneof.FeatureEnable.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &FeatureEnableRequest{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
...
func (m *FeatureEnableRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FeatureEnableRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FeatureEnableRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
...
func (m *SortedNotificationBatch) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SortedNotificationBatch: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SortedNotificationBatch: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			...
			m.Notifications = append(m.Notifications, &NotificationBatchEntry{})
...
func (m *NotificationBatchEntry) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NotificationBatchEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NotificationBatchEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LogEntryValue) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if oneof, ok := m.Value.(*LogEntryValue_ControlRequest); ok {
				if err := oneof.ControlRequest.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ControlRequest{}
...
func (m *ControlRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Value.(*ControlRequest_FeatureEnable); ok {
				if err := oneof.FeatureEnable.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &FeatureEnableRequest{}
...
func (m *FeatureEnableRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *SortedNotificationBatch) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *NotificationBatchEntry) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
