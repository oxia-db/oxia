...
func (m *AutoSplitConfig) CloneVT() *AutoSplitConfig {
	if m == nil {
		return (*AutoSplitConfig)(nil)
	}
	r := new(AutoSplitConfig)
	r.Enabled = m.Enabled
	r.MaxShardSizeMb = m.MaxShardSizeMb
	r.MaxThroughputOps = m.MaxThroughputOps
...
func (m *AutoSplitConfig) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ShardManagement) CloneVT() *ShardManagement {
	if m == nil {
		return (*ShardManagement)(nil)
	}
	r := new(ShardManagement)
	r.MaxShardsPerNamespace = m.MaxShardsPerNamespace
	r.AutoSplit = m.AutoSplit.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *ShardManagement) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *ClusterConfiguration) CloneVT() *ClusterConfiguration {
	...
	r.ShardManagement = m.ShardManagement.CloneVT()
...
func (this *AutoSplitConfig) EqualVT(that *AutoSplitConfig) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.MaxShardSizeMb != that.MaxShardSizeMb {
		return false
	}
	if this.MaxThroughputOps != that.MaxThroughputOps {
		return false
	}
	if this.StabilizationPeriod != that.StabilizationPeriod {
		return false
	}
	if this.CooldownPeriod != that.CooldownPeriod {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *AutoSplitConfig) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AutoSplitConfig)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *ShardManagement) EqualVT(that *ShardManagement) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if !this.AutoSplit.EqualVT(that.AutoSplit) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *ShardManagement) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ShardManagement)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *ClusterConfiguration) EqualVT(that *ClusterConfiguration) bool {
	...
	if !this.ShardManagement.EqualVT(that.ShardManagement) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *AutoSplitConfig) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AutoSplitConfig) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AutoSplitConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.CooldownPeriod) > 0 {
		i -= len(m.CooldownPeriod)
		copy(dAtA[i:], m.CooldownPeriod)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CooldownPeriod)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.StabilizationPeriod) > 0 {
		i -= len(m.StabilizationPeriod)
		copy(dAtA[i:], m.StabilizationPeriod)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.StabilizationPeriod)))
		i--
		dAtA[i] = 0x22
	}
	if m.MaxThroughputOps != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.MaxThroughputOps))
		i--
		dAtA[i] = 0x18
	}
	if m.MaxShardSizeMb != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.MaxShardSizeMb))
		i--
		dAtA[i] = 0x10
	}
	if m.Enabled {
...
func (m *ShardManagement) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ShardManagement) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ShardManagement) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.AutoSplit != nil {
		size, err := m.AutoSplit.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ClusterConfiguration) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ShardManagement != nil {
		size, err := m.ShardManagement.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *AutoSplitConfig) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MaxShardSizeMb != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.MaxShardSizeMb))
	}
	if m.MaxThroughputOps != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.MaxThroughputOps))
	}
	l = len(m.StabilizationPeriod)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	l = len(m.CooldownPeriod)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *ShardManagement) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AutoSplitConfig) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AutoSplitConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AutoSplitConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxShardSizeMb", wireType)
			}
			m.MaxShardSizeMb = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxShardSizeMb |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxThroughputOps", wireType)
			}
			m.MaxThroughputOps = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return protohelpers.ErrIntOverflow
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxThroughputOps |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StabilizationPeriod", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StabilizationPeriod = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.CooldownPeriod = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *ShardManagement) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardManagement: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardManagement: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxShardsPerNamespace", wireType)
			}
			m.MaxShardsPerNamespace = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return protohelpers.ErrIntOverflow
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxShardsPerNamespace |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoSplit", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AutoSplit == nil {
				m.AutoSplit = &AutoSplitConfig{}
			}
			if err := m.AutoSplit.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ClusterConfiguration) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShardManagement", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ShardManagement == nil {
				m.ShardManagement = &ShardManagement{}
			}
			if err := m.ShardManagement.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AutoSplitConfig) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 4:
			...
			m.StabilizationPeriod = stringValue
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CooldownPeriod", wireType)
...
func (m *ShardManagement) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			if err := m.AutoSplit.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ClusterConfiguration) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := m.ShardManagement.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
