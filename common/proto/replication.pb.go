...
var file_replication_proto_goTypes = []any{
	...
	(*ShardAssignments)(nil),                     // 26: io.oxia.proto.v1.ShardAssignments
}
var file_replication_proto_depIdxs = []int32{
	...
	6,  // 7: replication.TruncateRequest.head_entry_id:type_name -> replication.EntryId
	6,  // 8: replication.TruncateResponse.head_entry_id:type_name -> replication.EntryId
	7,  // 9: replication.Append.entry:type_name -> replication.LogEntry
	2,  // 10: replication.GetStatusResponse.status:type_name -> replication.ServingStatus
	6,  // 11: replication.BecomeLeaderRequest.FollowerMapsEntry.value:type_name -> replication.EntryId
	26, // 12: replication.OxiaCoordination.PushShardAssignments:input_type -> io.oxia.proto.v1.ShardAssignments
	10, // 13: replication.OxiaCoordination.NewTerm:input_type -> replication.NewTermRequest
	12, // 14: replication.OxiaCoordination.BecomeLeader:input_type -> replication.BecomeLeaderRequest
	13, // 15: replication.OxiaCoordination.AddFollower:input_type -> replication.AddFollowerRequest
	23, // 16: replication.OxiaCoordination.GetStatus:input_type -> replication.GetStatusRequest
	21, // 17: replication.OxiaCoordination.DeleteShard:input_type -> replication.DeleteShardRequest
	3,  // 18: replication.OxiaCoordination.GetInfo:input_type -> replication.GetInfoRequest
	16, // 19: replication.OxiaLogReplication.Truncate:input_type -> replication.TruncateRequest
	18, // 20: replication.OxiaLogReplication.Replicate:input_type -> replication.Append
	8,  // 21: replication.OxiaLogReplication.SendSnapshot:input_type -> replication.SnapshotChunk
	5,  // 22: replication.OxiaCoordination.PushShardAssignments:output_type -> replication.CoordinationShardAssignmentsResponse
	11, // 23: replication.OxiaCoordination.NewTerm:output_type -> replication.NewTermResponse
	14, // 24: replication.OxiaCoordination.BecomeLeader:output_type -> replication.BecomeLeaderResponse
	15, // 25: replication.OxiaCoordination.AddFollower:output_type -> replication.AddFollowerResponse
	24, // 26: replication.OxiaCoordination.GetStatus:output_type -> replication.GetStatusResponse
	22, // 27: replication.OxiaCoordination.DeleteShard:output_type -> replication.DeleteShardResponse
	4,  // 28: replication.OxiaCoordination.GetInfo:output_type -> replication.GetInfoResponse
	17, // 29: replication.OxiaLogReplication.Truncate:output_type -> replication.TruncateResponse
	19, // 30: replication.OxiaLogReplication.Replicate:output_type -> replication.Ack
	20, // 31: replication.OxiaLogReplication.SendSnapshot:output_type -> replication.SnapshotResponse
