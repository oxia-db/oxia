...
type NewTermResponse struct {
	...
	// features_supported contains the list of features supported by this node.
	// The coordinator will compute the intersection of features supported by all
	// quorum members and send the result to the leader.
...
func (x *NewTermResponse) GetFeaturesSupported() []Feature {
	if x != nil {
...
const file_replication_proto_rawDesc = "" +
	"\n" +
	"\x11replication.proto\x12\vreplication\x1a\fclient.proto\"&\n" +
	...
	"\aoptions\x18\x04 \x01(\v2\x1b.replication.NewTermOptionsR\aoptions\"\x90\x01\n" +
	"\x0fNewTermResponse\x128\n" +
	"\rhead_entry_id\x18\x01 \x01(\v2\x14.replication.EntryIdR\vheadEntryId\x12C\n" +
	"\x12features_supported\x18\x02 \x03(\x0e2\x14.replication.FeatureR\x11featuresSupported\"\x81\x03\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.replication.EntryIdR\x05value:\x028\x01\"\xcc\x01\n" +
	"\x12AddFollowerRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12\x14\n" +
	"\x05shard\x18\x02 \x01(\x03R\x05shard\x12\x12\n" +
	"\x04term\x18\x03 \x01(\x03R\x04term\x12#\n" +
	"\rfollower_name\x18\x04 \x01(\tR\ffollowerName\x12I\n" +
	"\x16follower_head_entry_id\x18\x05 \x01(\v2\x14.replication.EntryIdR\x13followerHeadEntryId\"\x16\n" +
	...
	"\fHIERARCHICAL\x10\x02*7\n" +
	"\aFeature\x12\x13\n" +
	"\x0fFEATURE_UNKNOWN\x10\x00\x12\x17\n" +
	"\x13FEATURE_FINGERPRINT\x10\x01*E\n" +
	...
	"\vDeleteShard\x12\x1f.replication.DeleteShardRequest\x1a .replication.DeleteShardResponse2\xe2\x01\n" +
...
var file_replication_proto_goTypes = []any{
	...
	(Feature)(0),        // 1: replication.Feature
	(ServingStatus)(0),  // 2: replication.ServingStatus
	(*CoordinationShardAssignmentsResponse)(nil), // 3: replication.CoordinationShardAssignmentsResponse
	(*EntryId)(nil),              // 4: replication.EntryId
	(*LogEntry)(nil),             // 5: replication.LogEntry
	(*SnapshotChunk)(nil),        // 6: replication.SnapshotChunk
	(*NewTermOptions)(nil),       // 7: replication.NewTermOptions
	(*NewTermRequest)(nil),       // 8: replication.NewTermRequest
	(*NewTermResponse)(nil),      // 9: replication.NewTermResponse
	(*BecomeLeaderRequest)(nil),  // 10: replication.BecomeLeaderRequest
	(*AddFollowerRequest)(nil),   // 11: replication.AddFollowerRequest
	(*BecomeLeaderResponse)(nil), // 12: replication.BecomeLeaderResponse
	(*AddFollowerResponse)(nil),  // 13: replication.AddFollowerResponse
	(*TruncateRequest)(nil),      // 14: replication.TruncateRequest
	(*TruncateResponse)(nil),     // 15: replication.TruncateResponse
	(*Append)(nil),               // 16: replication.Append
	(*Ack)(nil),                  // 17: replication.Ack
	(*SnapshotResponse)(nil),     // 18: replication.SnapshotResponse
	(*DeleteShardRequest)(nil),   // 19: replication.DeleteShardRequest
	(*DeleteShardResponse)(nil),  // 20: replication.DeleteShardResponse
	(*GetStatusRequest)(nil),     // 21: replication.GetStatusRequest
	(*GetStatusResponse)(nil),    // 22: replication.GetStatusResponse
	nil,                          // 23: replication.BecomeLeaderRequest.FollowerMapsEntry
...
var file_replication_proto_depIdxs = []int32{
	...
	7,  // 1: replication.NewTermRequest.options:type_name -> replication.NewTermOptions
	4,  // 2: replication.NewTermResponse.head_entry_id:type_name -> replication.EntryId
	1,  // 3: replication.NewTermResponse.features_supported:type_name -> replication.Feature
	23, // 4: replication.BecomeLeaderRequest.follower_maps:type_name -> replication.BecomeLeaderRequest.FollowerMapsEntry
	1,  // 5: replication.BecomeLeaderRequest.features_supported:type_name -> replication.Feature
	4,  // 6: replication.AddFollowerRequest.follower_head_entry_id:type_name -> replication.EntryId
	4,  // 7: replication.TruncateRequest.head_entry_id:type_name -> replication.EntryId
	4,  // 8: replication.TruncateResponse.head_entry_id:type_name -> replication.EntryId
	5,  // 9: replication.Append.entry:type_name -> replication.LogEntry
	2,  // 10: replication.GetStatusResponse.status:type_name -> replication.ServingStatus
	4,  // 11: replication.BecomeLeaderRequest.FollowerMapsEntry.value:type_name -> replication.EntryId
	24, // 12: replication.OxiaCoordination.PushShardAssignments:input_type -> io.oxia.proto.v1.ShardAssignments
	8,  // 13: replication.OxiaCoordination.NewTerm:input_type -> replication.NewTermRequest
	10, // 14: replication.OxiaCoordination.BecomeLeader:input_type -> replication.BecomeLeaderRequest
	11, // 15: replication.OxiaCoordination.AddFollower:input_type -> replication.AddFollowerRequest
	21, // 16: replication.OxiaCoordination.GetStatus:input_type -> replication.GetStatusRequest
	19, // 17: replication.OxiaCoordination.DeleteShard:input_type -> replication.DeleteShardRequest
	14, // 18: replication.OxiaLogReplication.Truncate:input_type -> replication.TruncateRequest
	16, // 19: replication.OxiaLogReplication.Replicate:input_type -> replication.Append
	6,  // 20: replication.OxiaLogReplication.SendSnapshot:input_type -> replication.SnapshotChunk
	3,  // 21: replication.OxiaCoordination.PushShardAssignments:output_type -> replication.CoordinationShardAssignmentsResponse
	9,  // 22: replication.OxiaCoordination.NewTerm:output_type -> replication.NewTermResponse
	12, // 23: replication.OxiaCoordination.BecomeLeader:output_type -> replication.BecomeLeaderResponse
	13, // 24: replication.OxiaCoordination.AddFollower:output_type -> replication.AddFollowerResponse
	22, // 25: replication.OxiaCoordination.GetStatus:output_type -> replication.GetStatusResponse
	20, // 26: replication.OxiaCoordination.DeleteShard:output_type -> replication.DeleteShardResponse
	15, // 27: replication.OxiaLogReplication.Truncate:output_type -> replication.TruncateResponse
	17, // 28: replication.OxiaLogReplication.Replicate:output_type -> replication.Ack
	18, // 29: replication.OxiaLogReplication.SendSnapshot:output_type -> replication.SnapshotResponse
