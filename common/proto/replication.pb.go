...
type Append struct {
	...
	CumulativeAcksSupported bool `protobuf:"varint,5,opt,name=cumulative_acks_supported,json=cumulativeAcksSupported,proto3" json:"cumulative_acks_supported,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Append) GetCumulativeAcksSupported() bool {
	if x != nil {
		return x.CumulativeAcksSupported
	}
	return false
}
...
func (x *FreezeShardRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *FreezeShardRequest) GetShard() int64 {
	if x != nil {
		return x.Shard
	}
	return 0
...
func (x *FreezeShardRequest) GetTerm() int64 {
	if x != nil {
		return x.Term
	}
	return 0
...
func (x *FreezeShardRequest) GetFrozen() bool {
	if x != nil {
		return x.Frozen
	}
	return false
...
func (x *FreezeShardResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_replication_proto_rawDesc = "" +
	...
	"\rhead_entry_id\x18\x01 \x01(\v2\x14.replication.EntryIdR\vheadEntryId\"\xf4\x01\n" +
	"\x06Append\x12\x12\n" +
	...
	"\x12previous_entry_crc\x18\x04 \x01(\rH\x00R\x10previousEntryCrc\x88\x01\x01\x12:\n" +
	"\x19cumulative_acks_supported\x18\x05 \x01(\bR\x17cumulativeAcksSupportedB\x15\n" +
	...
	"\x16RemoveObserverResponse\"t\n" +
	"\x12FreezeShardRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12\x14\n" +
	"\x05shard\x18\x02 \x01(\x03R\x05shard\x12\x12\n" +
	"\x04term\x18\x03 \x01(\x03R\x04term\x12\x16\n" +
	"\x06frozen\x18\x04 \x01(\bR\x06frozen\"6\n" +
	"\x13FreezeShardResponse\x12\x1f\n" +
	...
	"\x0eRemoveObserver\x12\".replication.RemoveObserverRequest\x1a#.replication.RemoveObserverResponse\x12P\n" +
	"\vFreezeShard\x12\x1f.replication.FreezeShardRequest\x1a .replication.FreezeShardResponse2\xe2\x01\n" +
...
var file_replication_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_replication_proto_goTypes = []any{
	...
	nil,                                          // 32: replication.BecomeLeaderRequest.FollowerMapsEntry
	(*Int32HashRange)(nil),                       // 33: io.oxia.proto.v1.Int32HashRange
	(*ShardAssignments)(nil),                     // 34: io.oxia.proto.v1.ShardAssignments
}
var file_replication_proto_depIdxs = []int32{
	...
	32, // 6: replication.BecomeLeaderRequest.follower_maps:type_name -> replication.BecomeLeaderRequest.FollowerMapsEntry
	...
	33, // 9: replication.AddFollowerRequest.split_hash_range:type_name -> io.oxia.proto.v1.Int32HashRange
	...
	34, // 15: replication.OxiaCoordination.PushShardAssignments:input_type -> io.oxia.proto.v1.ShardAssignments
	...
	30, // 19: replication.OxiaCoordination.GetStatus:input_type -> replication.GetStatusRequest
	...
	28, // 24: replication.OxiaCoordination.FreezeShard:input_type -> replication.FreezeShardRequest
	19, // 25: replication.OxiaLogReplication.Truncate:input_type -> replication.TruncateRequest
	21, // 26: replication.OxiaLogReplication.Replicate:input_type -> replication.Append
	11, // 27: replication.OxiaLogReplication.SendSnapshot:input_type -> replication.SnapshotChunk
	8,  // 28: replication.OxiaCoordination.PushShardAssignments:output_type -> replication.CoordinationShardAssignmentsResponse
	14, // 29: replication.OxiaCoordination.NewTerm:output_type -> replication.NewTermResponse
	17, // 30: replication.OxiaCoordination.BecomeLeader:output_type -> replication.BecomeLeaderResponse
	18, // 31: replication.OxiaCoordination.AddFollower:output_type -> replication.AddFollowerResponse
	31, // 32: replication.OxiaCoordination.GetStatus:output_type -> replication.GetStatusResponse
	25, // 33: replication.OxiaCoordination.DeleteShard:output_type -> replication.DeleteShardResponse
	7,  // 34: replication.OxiaCoordination.Handshake:output_type -> replication.HandshakeResponse
	5,  // 35: replication.OxiaCoordination.GetInfo:output_type -> replication.GetInfoResponse
	27, // 36: replication.OxiaCoordination.RemoveObserver:output_type -> replication.RemoveObserverResponse
	29, // 37: replication.OxiaCoordination.FreezeShard:output_type -> replication.FreezeShardResponse
	20, // 38: replication.OxiaLogReplication.Truncate:output_type -> replication.TruncateResponse
	22, // 39: replication.OxiaLogReplication.Replicate:output_type -> replication.Ack
	23, // 40: replication.OxiaLogReplication.SendSnapshot:output_type -> replication.SnapshotResponse
