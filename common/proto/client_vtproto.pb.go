...
func (m *ServerRedirect) CloneVT() *ServerRedirect {
	if m == nil {
		return (*ServerRedirect)(nil)
	}
	r := new(ServerRedirect)
	r.Shard = m.Shard
...
func (m *ServerRedirect) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *ServerRedirect) EqualVT(that *ServerRedirect) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ServerRedirect) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ServerRedirect)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *ServerRedirect) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ServerRedirect) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ServerRedirect) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ServerRedirect) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ServerRedirect) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServerRedirect: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServerRedirect: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ServerRedirect) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
