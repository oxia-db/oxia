...
type HierarchyPolicies struct {
	...
	InitialShardCount    *uint32                `protobuf:"varint,2,opt,name=initial_shard_count,json=initialShardCount,proto3,oneof" json:"initial_shard_count,omitempty"`
	...
	KeySorting           *string                `protobuf:"bytes,5,opt,name=key_sorting,json=keySorting,proto3,oneof" json:"key_sorting,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"\x04mode\x18\x02 \x01(\tR\x04mode\"\xfe\x02\n" +
	"\x11HierarchyPolicies\x12G\n" +
	"\x0fanti_affinities\x18\x01 \x03(\v2\x1e.io.oxia.proto.v1.AntiAffinityR\x0eantiAffinities\x123\n" +
	"\x13initial_shard_count\x18\x02 \x01(\rH\x00R\x11initialShardCount\x88\x01\x01\x122\n" +
	"\x12replication_factor\x18\x03 \x01(\rH\x01R\x11replicationFactor\x88\x01\x01\x128\n" +
	"\x15notifications_enabled\x18\x04 \x01(\bH\x02R\x14notificationsEnabled\x88\x01\x01\x12$\n" +
	"\vkey_sorting\x18\x05 \x01(\tH\x03R\n" +
	"keySorting\x88\x01\x01B\x16\n" +
	"\x14_initial_shard_countB\x15\n" +
	"\x13_replication_factorB\x18\n" +
	"\x16_notifications_enabledB\x0e\n" +
	"\f_key_sorting\"\\\n" +
	"\tNamespace\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12;\n" +
	"\x06policy\x18\x06 \x01(\v2#.io.oxia.proto.v1.HierarchyPoliciesR\x06policy\"d\n" +
	"\fLoadBalancer\x12+\n" +
	"\x11schedule_interval\x18\x01 \x01(\tR\x10scheduleInterval\x12'\n" +
	"\x0fquarantine_time\x18\x02 \x01(\tR\x0equarantineTime\"\x9b\x04\n" +
	...
	"\rload_balancer\x18\x05 \x01(\v2\x1e.io.oxia.proto.v1.LoadBalancerR\floadBalancer\x12;\n" +
...
var file_metadata_proto_depIdxs = []int32{
	...
	15, // 10: io.oxia.proto.v1.SplitMetadata.child_leaders_at_bootstrap:type_name -> io.oxia.proto.v1.SplitMetadata.ChildLeadersAtBootstrapEntry
	...
	0,  // 13: io.oxia.proto.v1.ShardMetadata.removed_nodes:type_name -> io.oxia.proto.v1.DataServerIdentity
	0,  // 14: io.oxia.proto.v1.ShardMetadata.pending_delete_shard_nodes:type_name -> io.oxia.proto.v1.DataServerIdentity
	8,  // 15: io.oxia.proto.v1.ShardMetadata.int32_hash_range:type_name -> io.oxia.proto.v1.HashRange
