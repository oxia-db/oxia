...
func (x *ShardAssignments) GetAuthorities() []string {
	if x != nil {
...
func (x *LeaderHint) GetShard() int64 {
	if x != nil {
		return x.Shard
	}
	return 0
...
var file_client_proto_goTypes = []any{
	...
	(*LeaderHint)(nil),                 // 38: io.oxia.proto.v1.LeaderHint
