...
type ListRequest struct {
	...
	SecondaryIndexName  *string `protobuf:"bytes,4,opt,name=secondary_index_name,json=secondaryIndexName,proto3,oneof" json:"secondary_index_name,omitempty"`
	IncludeInternalKeys bool    `protobuf:"varint,5,opt,name=include_internal_keys,json=includeInternalKeys,proto3" json:"include_internal_keys,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ListRequest) GetIncludeInternalKeys() bool {
	if x != nil {
		return x.IncludeInternalKeys
	}
	return false
}
...
func (x *RangeScanRequest) GetIncludeInternalKeys() bool {
	if x != nil {
		return x.IncludeInternalKeys
	}
	return false
...
// *
// ServerRedirect is used as error details when the server receiving
// the request is not the leader for the requested shard. The client
// can use the leader address to retry the request directly to the
// correct server.
type ServerRedirect struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The shard id for which this redirect applies
	Shard int64 `protobuf:"varint,1,opt,name=shard,proto3" json:"shard,omitempty"`
	// The address of the current leader for this shard (e.g. "host:port")
	LeaderAddress string `protobuf:"bytes,2,opt,name=leader_address,json=leaderAddress,proto3" json:"leader_address,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ServerRedirect) Reset() {
	*x = ServerRedirect{}
...
func (x *ServerRedirect) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerRedirect) ProtoMessage() {}

func (x *ServerRedirect) ProtoReflect() protoreflect.Message {
	mi := &file_client_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServerRedirect.ProtoReflect.Descriptor instead.
func (*ServerRedirect) Descriptor() ([]byte, []int) {
	return file_client_proto_rawDescGZIP(), []int{34}
}

func (x *ServerRedirect) GetShard() int64 {
	if x != nil {
		return x.Shard
	}
	return 0
...
func (x *ServerRedirect) GetLeaderAddress() string {
	if x != nil {
...
const file_client_proto_rawDesc = "" +
	...
	"\x14secondary_index_name\x18\x04 \x01(\tH\x01R\x12secondaryIndexName\x88\x01\x01\x122\n" +
	"\x15include_internal_keys\x18\x05 \x01(\bR\x13includeInternalKeysB\b\n" +
	"\x06_shardB\x17\n" +
	"\x15_secondary_index_name\"\"\n" +
	"\fListResponse\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\tR\x04keys\"\x89\x02\n" +
...
var file_client_proto_goTypes = []any{
	...
	(*ServerRedirect)(nil),             // 38: io.oxia.proto.v1.ServerRedirect
	nil,                                // 39: io.oxia.proto.v1.ShardAssignments.NamespacesEntry
	nil,                                // 40: io.oxia.proto.v1.NotificationBatch.NotificationsEntry
}
var file_client_proto_depIdxs = []int32{
	...
	40, // 21: io.oxia.proto.v1.NotificationBatch.notifications:type_name -> io.oxia.proto.v1.NotificationBatch.NotificationsEntry
