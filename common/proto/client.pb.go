...
type NotificationBatch struct {
	...
	Notifications []*NotificationEntry `protobuf:"bytes,4,rep,name=notifications,proto3" json:"notifications,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NotificationBatch) GetNotifications() []*NotificationEntry {
	if x != nil {
...
func (x *NotificationEntry) GetKey() string {
	if x != nil && x.Key != nil {
		return *x.Key
	}
	return ""
...
func (x *NotificationEntry) GetValue() *Notification {
	if x != nil {
		return x.Value
	}
	return nil
...
const file_client_proto_rawDesc = "" +
	...
	"\x17_start_offset_exclusive\"\xaa\x01\n" +
	"\x11NotificationBatch\x12\x14\n" +
	"\x05shard\x18\x01 \x01(\x03R\x05shard\x12\x16\n" +
	"\x06offset\x18\x02 \x01(\x03R\x06offset\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x06R\ttimestamp\x12I\n" +
	"\rnotifications\x18\x04 \x03(\v2#.io.oxia.proto.v1.NotificationEntryR\rnotifications\"h\n" +
	"\x11NotificationEntry\x12\x15\n" +
...
func file_client_proto_init() {
	...
	file_client_proto_msgTypes[34].OneofWrappers = []any{}
	type x struct{}
