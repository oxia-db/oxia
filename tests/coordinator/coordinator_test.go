...
func TestCoordinatorInitiateLeaderElection(t *testing.T) {
	...
	metadataProvider := metadata2.NewProvider(metadatacodec.ClusterStatusCodec, metadatacommon.WatchDisabled, nil)
	...
	configProvider := metadata2.NewProvider(metadatacodec.ClusterConfigCodec, metadatacommon.WatchEnabled, nil)
