...
func setupSplitTest(t *testing.T, phase string) (
	...
	*mockSplitEventListener,
	...
	metadata := coordmetadata.New(t.Context(), metaProvider, coordmetadata.NewClusterConfigProviderFromLoader(t.Context(), func() (*proto.ClusterConfiguration, error) {
		return validTestClusterConfig(nil), nil
	}, nil))
