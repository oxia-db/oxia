...
import (
	...
	"github.com/oxia-db/oxia/oxiad/coordinator/selectors/leader"
...
type shardController struct {
	...
	leaderSelector selectors.Selector[*leader.Context, model.Server]
...
func NewShardController(
	...
	s := &shardController{
		...
		leaderSelector:   leader.NewSelector(),
