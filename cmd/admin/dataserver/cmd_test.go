...
func Test_cmd_dataServerList(t *testing.T) {
	...
	assert.Equal(t, "public1", dataServers[0].GetPublicAddress())
	assert.Equal(t, "public2", dataServers[1].GetPublicAddress())
	assert.Equal(t, "internal1", dataServers[0].GetInternalAddress())
	assert.Equal(t, "internal2", dataServers[1].GetInternalAddress())
